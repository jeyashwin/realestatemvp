    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('parkingSpace', models.IntegerField(blank=True, help_text='Available Parking Space. Eg 1 or 2', null=True, validators=[django.core.validators.MinValueValidator(0, 'Minimum 0'), django.core.validators.MaxValueValidator(20, 'Maximum 20')], verbose_name='Parking Space')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('imageDescription', models.CharField(help_text='Describe about image. Eg Bathroom', max_length=50, verbose_name='Image Description')),
